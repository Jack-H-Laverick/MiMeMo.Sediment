...
Barents Sea sediments, created by the Norwegian geological survey. NGU
sediment classes are then predicted for the mapped area, before
calculating percent of different sediment fractions, mean grain size,
porosity, permeability, organic matter content, and mean daily
disturbance by month.
...
| 12 OMC                   | Predict organic matter content of sediments using % silt.                    |
| 13 PERM PORE             | Predict sediment porosity and permeability using mean sediment diameter.     |
| 14 WRITE NETCDF          | Save static layers as a NetCDF file.                                         |
| 15 SEASONAL STRESS       | Calculate mean 95th percentile of bed shear stress per month.                |
